        ...
        <div class="bs-stepper">
            ...
            <div class="bs-stepper-content">
                <form class="was-validated"
                    action="{{ route('updateFormStepper', ['id' => $data['pasien_id'], 'step' => 1]) }}" method="POST"
                    novalidate>
                    @csrf
                        ...
                        <div class="form-section">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <input class="form-control @error('nama_anak') is-invalid @enderror" id="namaAnak"
                                        name="nama_anak" placeholder="Masukkan Nama" type="text"
                                        value="{{ old('nama_anak', $data['infoAnak']->nama_anak ?? '') }}" required
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <input class="form-control @error('tempat_lahir') is-invalid @enderror"
                                        id="tempatLahir" name="tempat_lahir" placeholder="Masukkan Tempat Lahir"
                                        type="text"
                                        value="{{ old('tempat_lahir', $data['infoAnak']->tempat_lahir ?? '') }}"
                                        required pattern="[A-Za-z\s]+" title="Hanya boleh huruf dan spasi" />
                                    @error('tempat_lahir')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <input class="form-control @error('nama_panggilan') is-invalid @enderror"
                                        id="namaPanggilan" name="nama_panggilan" placeholder="Masukkan Nama" type="text"
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <input class="form-control @error('tanggal_lahir') is-invalid @enderror"
                                        id="tanggalLahir" name="tanggal_lahir" type="date"
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <select class="form-control @error('jenis_kelamin') is-invalid @enderror"
                                        id="jenisKelamin" name="jenis_kelamin" required>
                                        <option value="" disabled {{ old('jenis_kelamin', $data['infoAnak']->jenis_kelamin ?? '') == '' ? 'selected' : '' }}>Pilih Jenis
                                            Kelamin</option>
                                        <option value="Laki-laki" {{ old('jenis_kelamin', $data['infoAnak']->jenis_kelamin ?? '') == 'Laki-laki' ? 'selected' : '' }}>
                                            Laki-laki</option>
                                        <option value="Perempuan" {{ old('jenis_kelamin', $data['infoAnak']->jenis_kelamin ?? '') == 'Perempuan' ? 'selected' : '' }}>
                                            Perempuan</option>
                                    </select>
                                    @error('jenis_kelamin')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <input class="form-control" id="umurAnak" name="umur_anak" type="text"
                                        value="{{ old('umur_anak', $umurAnak ?? '') }}" readonly />
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="namaAyah" name="nama_ayah"
                                            placeholder="Masukkan Nama Ayah" type="text" required pattern="[A-Za-z\s]+"
                                            value="{{ old('nama_ayah', $data['infoAnak']->nama_ayah) }}"
                                            title="Hanya boleh huruf dan spasi" oninput="validateInput(this)" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="usiaAyah" name="usia_ayah"
                                            placeholder="Masukkan Usia Ayah" type="number" min="0" max="120" required
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="pekerjaanAyah" name="pekerjaan_ayah"
                                            placeholder="Masukkan Pekerjaan Ayah" type="text" required
                                            pattern="[A-Za-z\s]+"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="namaIbu" name="nama_ibu"
                                            placeholder="Masukkan Nama Ibu" type="text" required pattern="[A-Za-z\s]+"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="usiaIbu" name="usia_ibu"
                                            placeholder="Masukkan Usia Ibu" type="number" min="0" max="120" required
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="pekerjaanIbu" name="pekerjaan_ibu"
                                            placeholder="Masukkan Pekerjaan Ibu" type="text" required
                                            pattern="[A-Za-z\s]+"
